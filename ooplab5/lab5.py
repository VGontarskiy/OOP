...
class IUserManager(ABC):  # задает интерфейс для отслеживания пользователей
    @abstractmethod
...
class IRepository(ABC):  #задает интерфейс для работы с хранилищем данных
    @abstractmethod
    def GetAll(self):
        pass
...
# Авторизация последнего вошедшего пользователя
